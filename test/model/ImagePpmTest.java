...
public class ImagePpmTest {
  ...
  Image modelOne = new ImagePpm(255, mockPixels);
  Image modelTwo = new ImagePpm(255, mockPixelsWide);
  ...
  public void testPixelFetch() {
    ...
    Image rotateOne = new ConvertByHorizontal().apply(this.modelOne);
  ...
  public void testCommandReceive() {
    Image blue = this.modelOne.convertToViz(new CommandsValue());
